...
girl_power_list = List.create!(name: "Girl Power")

puts "Creating bookmarks..."
Bookmark.create!(movie: movie1, list: girl_power_list, comment: "Strong female lead")
Bookmark.create!(movie: movie2, list: drama_list, comment: "Classic prison escape")
Bookmark.create!(movie: movie3, list: drama_list, comment: "Epic love story")
Bookmark.create!(movie: movie4, list: girl_power_list, comment: "All-female heist team")
